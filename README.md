...
Este espaço é dedicado a compartilhar projetos que integram programação e ciência de dados, aplicados em diferentes contextos — da análise de fenômenos naturais ao desenvolvimento de ferramentas práticas.
Meu objetivo é contribuir com a comunidade por meio de soluções bem documentadas, acessíveis e tecnicamente consistentes.

Grande parte do meu trabalho não pode ser publicada, pois está protegida pelos direitos das empresas em que atuei.
